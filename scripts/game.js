...
//take
			...
			//dead bugs
				...
				if (currentroom == "jail" && deadbugs == false) {
					deadbugs = true;
					$('<p>You picked up some dead bugs.</p>').insertBefore("#placeholder").fadeIn(1000);
				}
				else $('<p>That item is not here!</p>').insertBefore("#placeholder").fadeIn(1000);
			}
			...
			//note
				...
				if (currentroom == "hallway" && note == false) {
					note = true;
					$('<p>You picked up a note. It reads: <br/>Well now. It seems you have managed to pass your first test. You will die if you not wake up on time. Don\'t worry. Things will get plenty more fun for you to escape.<br/><br />Sincerely,<br/>Your life Manager <br/><br/>P.S. Watch out for my baby tiger.</p>').insertBefore("#placeholder").fadeIn(1000);
				}
				else $('<p>That item is not here!</p>').insertBefore("#placeholder").fadeIn(1000);
			}
			...
			//whip
				...
				if (currentroom == "torture" && whip == false) {
					...
					if (whip == true && hat == true) {
						$('<p>A whip and a hat? This is no time to play Straw hat game!</p>').insertBefore("#placeholder").fadeIn(1000);
					}
				}
				else $('<p>That item is not here!</p>').insertBefore("#placeholder").fadeIn(1000);
			}
		...
		//eat
			...
			//bugs
				...
				if (deadbugs == true) {
					$('<p>Oh, You carzy.</p>').insertBefore("#placeholder").fadeIn(1000);
					deadbugs = "ate";
				}
				else $('<p>You can\'t do that.</p>').insertBefore("#placeholder").fadeIn(1000);
			}
		...
		//kill
			...
			else if (input == "kill tiger with lunch tray" || input == "kill tiger with lunchtray" || input == "kill tiger with tray") {
				if (currentroom == "farm" && lunchtray == true) {
					$('<p>You attack the tiger with a lunch tray and kill it!</p>').insertBefore("#placeholder").fadeIn(1000);
					tigerdead = true;
				}
				else {
					$('<p>You can\'t do that.</p>').insertBefore("#placeholder").fadeIn(1000);
		...
		//go
			...
			//go to westhallway from exit
               ...
               // go bones room 3 from exit room
				...
				if (beentobonus3 == true) {
					...
					$("#area_bonus3").clone().insertBefore("#placeholder").fadeIn(1000);
					beentobonus3 = true;
					currentroom = "bonus3";
				}
			}
			...
			//go to bonus room from westhall
				...
				if (beentobonus == true) {
					...
					$('<p>You are back in the storage room. You came from the north. ' + bonuscrate + '</p>').insertBefore("#placeholder").fadeIn(1000);
					currentroom = "bonus";
				}
				else {
            ...
            // go bones room 2 
				...
				if (beentobonus2 == true) {
					...
					$('<p>You are back in the storage room. You came from the east.' + bonuscrate + '</p>').insertBefore("#placeholder").fadeIn(1000);
					currentroom = "bonus2";
				}
				else {
					$("#area_bonus2").clone().insertBefore("#placeholder").fadeIn(1000);
					beentobonus2 = true;
					currentroom = "bonus2";
				}
			}
            //go to westhall from bonus room 2
			else if (input == "go east" && currentroom == "bonus2") {
			...
			//go to farm from torture room
			else if (input == "go south" && currentroom == "torture") {
				if (beenfarm == true) {
					if (tigerdead == false) {
						farm = "The tiger is still here!";
					}
					else {
						farm = "The tiger remains on the floor rotting in a cesspool of it's juices.";
					}
					$('<p>You are back in the farm. To the north is the doorway to the room of strange devices. ' + farm + '</p>').insertBefore("#placeholder").fadeIn(1000);
					currentroom = "farm";
				}
				else {
					$("#area_farm").clone().insertBefore("#placeholder").fadeIn(1000);
					beenfarm = true;
					currentroom = "farm";
				}
			}

			//go to torture room from farm
			else if (input == "go north" && currentroom == "farm") {
				if (searchtable == false) {
					torturetable = "The table seems to emit a strange energy. ";
				}
				else {
